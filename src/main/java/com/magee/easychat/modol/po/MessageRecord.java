...
public class MessageRecord {
    ...
    public MessageRecord(Integer id, Integer userId, String userName, Integer messageType, String content, Date createTime) {
        this.id = id;
        this.userId = userId;
    ...
    public static class MessageRecordBuilder{
        ...
        public MessageRecord build(){
            return new MessageRecord(id, userId, userName, messageType, content, createTime);
        }
    }
